...
function Boss:update(dt)
  ...
  for id,gun in pairs(self.guns) do
    ...
    if t - gun.time_of_last_fire > gun.rate_of_fire then
      local x = self.pos.x + 10 * math.cos(self.angle + gun.orientation)
      local y = self.pos.y + 10 * math.sin(self.angle + gun.orientation)
